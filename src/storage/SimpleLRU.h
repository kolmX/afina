...
public:
    SimpleLRU(size_t max_size = 1024) : _max_size(max_size),
     _busy_memory(0), _lru_head(nullptr) {}
...
private:
    ...
    using lru_node = struct lru_node {
        ...
        std::string value;
        lru_node* prev;
        std::unique_ptr<lru_node> next; // why unique_ptr , not shared_ptr?
    };
    ...
    //Function free last elements;
    //Returns number realised
